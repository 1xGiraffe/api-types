...
import type { CommonRuntimeAssetLocation, CommonRuntimeProxyType, FrameSupportDispatchDispatchInfo, FrameSupportTokensMiscBalanceStatus, OrmlVestingVestingSchedule, PalletAssetRegistryAssetType, PalletDemocracyVoteAccountVote, PalletDemocracyVoteThreshold, PalletLbpPool, PalletLiquidityMiningLoyaltyCurve, PalletMultisigTimepoint, PalletNftCollectionType, PrimitivesAssetAssetPair, SpRuntimeDispatchError, SpWeightsWeightV2Weight, XcmV3MultiAsset, XcmV3MultiLocation, XcmV3MultiassetMultiAssets, XcmV3Response, XcmV3TraitsError, XcmV3TraitsOutcome, XcmV3Xcm, XcmVersionedMultiAssets, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    proxy: {
       ...
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: CommonRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: CommonRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    router: {
       ...
       **/
      RouteExecuted: AugmentedEvent<ApiType, [assetIn: u32, assetOut: u32, amountIn: u128, amountOut: u128], { assetIn: u32, assetOut: u32, amountIn: u128, amountOut: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    xykLiquidityMining: {
       ...
       **/
      YieldFarmCreated: AugmentedEvent<ApiType, [globalFarmId: u32, yieldFarmId: u32, multiplier: u128, assetPair: PrimitivesAssetAssetPair, loyaltyCurve: Option<PalletLiquidityMiningLoyaltyCurve>], { globalFarmId: u32, yieldFarmId: u32, multiplier: u128, assetPair: PrimitivesAssetAssetPair, loyaltyCurve: Option<PalletLiquidityMiningLoyaltyCurve> }>;
      /**
       * Yield farm for asset pair was resumed.
       **/
      YieldFarmResumed: AugmentedEvent<ApiType, [globalFarmId: u32, yieldFarmId: u32, who: AccountId32, assetPair: PrimitivesAssetAssetPair, multiplier: u128], { globalFarmId: u32, yieldFarmId: u32, who: AccountId32, assetPair: PrimitivesAssetAssetPair, multiplier: u128 }>;
      /**
       * Yield farm for asset pair was stopped.
       **/
      YieldFarmStopped: AugmentedEvent<ApiType, [globalFarmId: u32, yieldFarmId: u32, who: AccountId32, assetPair: PrimitivesAssetAssetPair], { globalFarmId: u32, yieldFarmId: u32, who: AccountId32, assetPair: PrimitivesAssetAssetPair }>;
      /**
       * Yield farm was terminated from global farm.
       **/
      YieldFarmTerminated: AugmentedEvent<ApiType, [globalFarmId: u32, yieldFarmId: u32, who: AccountId32, assetPair: PrimitivesAssetAssetPair], { globalFarmId: u32, yieldFarmId: u32, who: AccountId32, assetPair: PrimitivesAssetAssetPair }>;
      /**
       * Yield farm multiplier was updated.
       **/
      YieldFarmUpdated: AugmentedEvent<ApiType, [globalFarmId: u32, yieldFarmId: u32, who: AccountId32, assetPair: PrimitivesAssetAssetPair, multiplier: u128], { globalFarmId: u32, yieldFarmId: u32, who: AccountId32, assetPair: PrimitivesAssetAssetPair, multiplier: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;

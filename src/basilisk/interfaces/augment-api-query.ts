  ...
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assetRegistry: {
      ...
      assetLocations: AugmentedQuery<
        ...
        ) => Observable<Option<BasiliskRuntimeXcmAssetLocation>>,
        [u32]
      > &
      ...
      locationAssets: AugmentedQuery<
        ...
        [BasiliskRuntimeXcmAssetLocation]
      > &
        QueryableStorageEntry<ApiType, [BasiliskRuntimeXcmAssetLocation]>;
      /**
    ...
    referenda: {
      ...
      /**
       * The metadata is a general information concerning the referendum. The
       * `Hash` refers to the preimage of the `Preimages` provider which can be
       * a JSON dump or IPFS hash of a JSON file.
       *
       * Consider a garbage collection for a metadata of finished referendums to
       * `unrequest` (remove) large preimages.
       */

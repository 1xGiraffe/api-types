...
import type { AccountId32, Call, H256, Perquintill } from '@polkadot/types/interfaces/runtime';
import type { BasiliskRuntimeOpaqueSessionKeys, BasiliskRuntimeOriginCaller, CommonRuntimeAssetLocation, CommonRuntimeProxyType, CumulusPrimitivesParachainInherentParachainInherentData, FrameSupportPreimagesBounded, OrmlVestingVestingSchedule, PalletAssetRegistryAssetType, PalletAssetRegistryMetadata, PalletDemocracyConviction, PalletDemocracyVoteAccountVote, PalletElectionsPhragmenRenouncing, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletLbpWeightCurveType, PalletLiquidityMiningLoyaltyCurve, PalletMultisigTimepoint, PalletNftCollectionType, PalletRouteExecutorTrade, PalletUniquesDestroyWitness, PrimitivesAssetAssetPair, SpWeightsWeightV2Weight, XcmV3MultiLocation, XcmV3WeightLimit, XcmVersionedMultiAsset, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetRegistry: {
       ...
       **/
      register: AugmentedSubmittable<(name: Bytes | string | Uint8Array, assetType: PalletAssetRegistryAssetType | { Token: any } | { PoolShare: any } | string | Uint8Array, existentialDeposit: u128 | AnyNumber | Uint8Array, assetId: Option<u32> | null | Uint8Array | u32 | AnyNumber, metadata: Option<PalletAssetRegistryMetadata> | null | Uint8Array | PalletAssetRegistryMetadata | { symbol?: any; decimals?: any } | string, location: Option<CommonRuntimeAssetLocation> | null | Uint8Array | CommonRuntimeAssetLocation | { parents?: any; interior?: any } | string, xcmRateLimit: Option<u128> | null | Uint8Array | u128 | AnyNumber) => SubmittableExtrinsic<ApiType>, [Bytes, PalletAssetRegistryAssetType, u128, Option<u32>, Option<PalletAssetRegistryMetadata>, Option<CommonRuntimeAssetLocation>, Option<u128>]>;
      /**
    ...
    proxy: {
       ...
       **/
      createPure: AugmentedSubmittable<(proxyType: CommonRuntimeProxyType | 'Any' | 'CancelProxy' | 'Governance' | 'Exchange' | 'Transfer' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonRuntimeProxyType, u32, u16]>;
      /**
    ...
    xykLiquidityMining: {
       ...
       **/
      createYieldFarm: AugmentedSubmittable<(globalFarmId: u32 | AnyNumber | Uint8Array, assetPair: PrimitivesAssetAssetPair | { assetIn?: any; assetOut?: any } | string | Uint8Array, multiplier: u128 | AnyNumber | Uint8Array, loyaltyCurve: Option<PalletLiquidityMiningLoyaltyCurve> | null | Uint8Array | PalletLiquidityMiningLoyaltyCurve | { initialRewardPercentage?: any; scaleCoef?: any } | string) => SubmittableExtrinsic<ApiType>, [u32, PrimitivesAssetAssetPair, u128, Option<PalletLiquidityMiningLoyaltyCurve>]>;
      /**
       ...
       **/
      depositShares: AugmentedSubmittable<(globalFarmId: u32 | AnyNumber | Uint8Array, yieldFarmId: u32 | AnyNumber | Uint8Array, assetPair: PrimitivesAssetAssetPair | { assetIn?: any; assetOut?: any } | string | Uint8Array, sharesAmount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, PrimitivesAssetAssetPair, u128]>;
      /**
       ...
       **/
      redepositShares: AugmentedSubmittable<(globalFarmId: u32 | AnyNumber | Uint8Array, yieldFarmId: u32 | AnyNumber | Uint8Array, assetPair: PrimitivesAssetAssetPair | { assetIn?: any; assetOut?: any } | string | Uint8Array, depositId: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, PrimitivesAssetAssetPair, u128]>;
      /**
       ...
       **/
      resumeYieldFarm: AugmentedSubmittable<(globalFarmId: u32 | AnyNumber | Uint8Array, yieldFarmId: u32 | AnyNumber | Uint8Array, assetPair: PrimitivesAssetAssetPair | { assetIn?: any; assetOut?: any } | string | Uint8Array, multiplier: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, PrimitivesAssetAssetPair, u128]>;
      /**
       ...
       **/
      stopYieldFarm: AugmentedSubmittable<(globalFarmId: u32 | AnyNumber | Uint8Array, assetPair: PrimitivesAssetAssetPair | { assetIn?: any; assetOut?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, PrimitivesAssetAssetPair]>;
      /**
       ...
       **/
      terminateYieldFarm: AugmentedSubmittable<(globalFarmId: u32 | AnyNumber | Uint8Array, yieldFarmId: u32 | AnyNumber | Uint8Array, assetPair: PrimitivesAssetAssetPair | { assetIn?: any; assetOut?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, PrimitivesAssetAssetPair]>;
      /**
       ...
       **/
      updateYieldFarm: AugmentedSubmittable<(globalFarmId: u32 | AnyNumber | Uint8Array, assetPair: PrimitivesAssetAssetPair | { assetIn?: any; assetOut?: any } | string | Uint8Array, multiplier: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, PrimitivesAssetAssetPair, u128]>;
      /**
       ...
       **/
      withdrawShares: AugmentedSubmittable<(depositId: u128 | AnyNumber | Uint8Array, yieldFarmId: u32 | AnyNumber | Uint8Array, assetPair: PrimitivesAssetAssetPair | { assetIn?: any; assetOut?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, u32, PrimitivesAssetAssetPair]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;

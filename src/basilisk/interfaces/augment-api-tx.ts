...
import type { AccountId32, Call, H256, Perbill, Perquintill, WeightV1 } from '@polkadot/types/interfaces/runtime';
import type { BasiliskRuntimeOpaqueSessionKeys, BasiliskRuntimeOriginCaller, CommonRuntimeAssetLocation, CommonRuntimeProxyType, CumulusPrimitivesParachainInherentParachainInherentData, FrameSupportScheduleMaybeHashed, OrmlVestingVestingSchedule, PalletAssetRegistryAssetType, PalletAssetRegistryMetadata, PalletDemocracyConviction, PalletDemocracyVoteAccountVote, PalletElectionsPhragmenRenouncing, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletLbpWeightCurveType, PalletLiquidityMiningLoyaltyCurve, PalletMultisigTimepoint, PalletNftCollectionType, PalletRouteExecutorTrade, PalletUniquesDestroyWitness, PrimitivesAssetAssetPair, SpRuntimeHeader, XcmV1MultiLocation, XcmV2WeightLimit, XcmVersionedMultiAsset, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetRegistry: {
       ...
       **/
      register: AugmentedSubmittable<(name: Bytes | string | Uint8Array, assetType: PalletAssetRegistryAssetType | { Token: any } | { PoolShare: any } | string | Uint8Array, existentialDeposit: u128 | AnyNumber | Uint8Array, assetId: Option<u32> | null | Uint8Array | u32 | AnyNumber, metadata: Option<PalletAssetRegistryMetadata> | null | Uint8Array | PalletAssetRegistryMetadata | { symbol?: any; decimals?: any } | string, location: Option<CommonRuntimeAssetLocation> | null | Uint8Array | CommonRuntimeAssetLocation | { parents?: any; interior?: any } | string) => SubmittableExtrinsic<ApiType>, [Bytes, PalletAssetRegistryAssetType, u128, Option<u32>, Option<PalletAssetRegistryMetadata>, Option<CommonRuntimeAssetLocation>]>;
      /**

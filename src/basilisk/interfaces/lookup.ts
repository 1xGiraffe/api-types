...
export default {
  ...
  /**
   * Lookup18: frame_system::EventRecord<basilisk_runtime::RuntimeEvent,
  ...
  /**
   * Lookup346: pallet_democracy::types::ReferendumInfo<BlockNumber,
   * frame_support::traits::preimages::Bounded<basilisk_runtime::RuntimeCall>, Balance>
   */
  ...
  /**
   * Lookup347: pallet_democracy::types::ReferendumStatus<BlockNumber,
   * frame_support::traits::preimages::Bounded<basilisk_runtime::RuntimeCall>, Balance>
   */
  ...
  /**
   * Lookup349: pallet_democracy::vote::Voting<Balance,
  ...
  /**
   * Lookup371: pallet_proxy::ProxyDefinition<sp_core::crypto::AccountId32,
  ...
  /**
   * Lookup375: pallet_proxy::Announcement<sp_core::crypto::AccountId32,
  ...
  /**
   * Lookup378: pallet_tips::OpenTip<sp_core::crypto::AccountId32, Balance,
  ...
  /**
   * Lookup402: pallet_uniques::types::ItemDetails<sp_core::crypto::AccountId32,
   * DepositBalance>
   */
  ...
  /**
   * Lookup409: pallet_identity::types::Registration<Balance, MaxJudgements,
   * MaxAdditionalFields>
   */
  ...
  /**
   * Lookup417: pallet_identity::types::RegistrarInfo<Balance,
  ...
  /**
   * Lookup421: pallet_multisig::Multisig<BlockNumber, Balance,
  ...
  /**
   * Lookup441: pallet_scheduler::Scheduled<Name,
   * frame_support::traits::preimages::Bounded<basilisk_runtime::RuntimeCall>,
   * BlockNumber, basilisk_runtime::OriginCaller, sp_core::crypto::AccountId32>
   */
  ...
  /**
   * Lookup483: pallet_asset_registry::types::AssetDetails<AssetId, Balance,
  ...
  /**
   * Lookup491:
   * pallet_nft::types::ItemInfo<sp_core::bounded::bounded_vec::BoundedVec<T, S>>
   */
  PalletNftItemInfo: {
    metadata: "Bytes",
  },
  ...
  /**
   * Lookup496: pallet_marketplace::types::Offer<sp_core::crypto::AccountId32,
   * Balance, BlockNumber>
   */

...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletSchedulerScheduledV3 (436) */
  ...
  /** @name PalletXcmVersionMigrationStage (447) */
  ...
  /** @name PalletAssetRegistryAssetDetails (469) */
  ...
  /** @name PalletAssetRegistryAssetMetadata (470) */
  interface PalletAssetRegistryAssetMetadata extends Struct {
    readonly symbol: Bytes;
    readonly decimals: u8;
  }

  /** @name PalletAssetRegistryError (471) */
  ...
  /** @name PalletTransactionMultiPaymentError (479) */
  ...
  /** @name PalletRelaychainInfoError (480) */
  type PalletRelaychainInfoError = Null;

  /** @name PalletMarketplaceOffer (482) */
  ...
  /** @name PalletMarketplaceRoyalty (483) */
  interface PalletMarketplaceRoyalty extends Struct {
    readonly author: AccountId32;
    readonly royalty: u16;
  }

  /** @name PalletMarketplaceError (484) */
  ...
  /** @name PalletTransactionPauseError (485) */
  ...
  /** @name PalletRouteExecutorError (486) */
  interface PalletRouteExecutorError extends Enum {
    ...
    readonly type: 'TradingLimitReached' | 'MaxTradesExceeded' | 'PoolNotSupported' | 'RouteHasNoTrades' | 'InsufficientBalance' | 'UnexpectedError';
  }

  /** @name PalletXykLiquidityMiningError (487) */
  ...
  /** @name PalletLiquidityMiningGlobalFarmData (488) */
  ...
  /** @name PalletLiquidityMiningFarmState (489) */
  ...
  /** @name PalletLiquidityMiningYieldFarmData (491) */
  ...
  /** @name PalletLiquidityMiningDepositData (492) */
  ...
  /** @name PalletLiquidityMiningYieldFarmEntry (494) */
  ...
  /** @name PalletLiquidityMiningError (496) */
  ...
  /** @name PalletLiquidityMiningInconsistentStateError (497) */
  ...
  /** @name PalletCurrenciesModuleError (498) */
  ...
  /** @name OrmlTokensBalanceLock (500) */
  interface OrmlTokensBalanceLock extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name OrmlTokensAccountData (502) */
  ...
  /** @name OrmlTokensReserveData (504) */
  interface OrmlTokensReserveData extends Struct {
    readonly id: Null;
    readonly amount: u128;
  }

  /** @name OrmlTokensModuleError (506) */
  ...
  /** @name OrmlXtokensModuleError (508) */
  ...
  /** @name OrmlUnknownTokensModuleError (511) */
  ...
  /** @name SpCoreEd25519Signature (514) */
  ...
  /** @name PalletTransactionMultiPaymentCurrencyBalanceCheck (528) */
  type PalletTransactionMultiPaymentCurrencyBalanceCheck = Null;

  /** @name BasiliskRuntimeRuntime (529) */

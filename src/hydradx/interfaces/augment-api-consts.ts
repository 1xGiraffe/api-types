...
import type { Percent, Permill, WeightV1 } from '@polkadot/types/interfaces/runtime';
import type { FrameSupportPalletId, FrameSupportWeightsRuntimeDbWeight, FrameSystemLimitsBlockLength, FrameSystemLimitsBlockWeights, HydradxTraitsOracleOraclePeriod, SpVersionRuntimeVersion, XcmV1MultiLocation } from '@polkadot/types/lookup';

...
declare module "@polkadot/api-base/types/errors" {
  interface AugmentedErrors<ApiType extends ApiTypes> {
    ...
    dca: {
      ...
      TradeAmountIsLessThanFee: AugmentedError<ApiType>;
    ...
    omnipool: {
      ...
      /**
       * Adding token as protocol ( root ), token balance has not been updated
       * prior to add token.
       */
    ...
    router: {
      ...
      /**
       * Unexpected error which should never really happen, but the error case
       * must be handled to prevent panics.
       */

...
declare module "@polkadot/api-base/types/events" {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetRegistry: {
      ...
      /**
       * Existential deposit for insufficinet asset was paid. `SufficiencyCheck`
       * triggers this event.
       */
      ExistentialDepositPaid: AugmentedEvent<
        ApiType,
        [who: AccountId32, feeAsset: u32, amount: u128],
        { who: AccountId32; feeAsset: u32; amount: u128 }
      >;
      /** Native location set for an asset. */
      LocationSet: AugmentedEvent<
        ApiType,
        [assetId: u32, location: HydradxRuntimeXcmAssetLocation],
        { assetId: u32; location: HydradxRuntimeXcmAssetLocation }
      >;
    ...
    bonds: {
      ...
      Issued: AugmentedEvent<
        ApiType,
        [issuer: AccountId32, bondId: u32, amount: u128, fee: u128],
        { issuer: AccountId32; bondId: u32; amount: u128; fee: u128 }
      >;
      /** Bonds were redeemed */
      Redeemed: AugmentedEvent<
        ApiType,
        [who: AccountId32, bondId: u32, amount: u128],
        { who: AccountId32; bondId: u32; amount: u128 }
      >;
      /** A bond asset was registered */
      TokenCreated: AugmentedEvent<
        ApiType,
        [issuer: AccountId32, assetId: u32, bondId: u32, maturity: u64],
        { issuer: AccountId32; assetId: u32; bondId: u32; maturity: u64 }
      >;
      /** Generic event */
      [key: string]: AugmentedEvent<ApiType>;
    ...
    collatorSelection: {
      ...
      >;
      /**
       * An account was unable to be added to the Invulnerables because they did
       * not have keys registered. Other Invulnerables may have been set.
       */
    ...
    cumulusXcm: {
      ...
      ExecutedDownward: AugmentedEvent<
        ApiType,
        [U8aFixed, StagingXcmV4TraitsOutcome]
      >;
    ...
    emaOracle: {
      ...
      AddedToWhitelist: AugmentedEvent<
        ApiType,
        [source: U8aFixed, assets: ITuple<[u32, u32]>],
        { source: U8aFixed; assets: ITuple<[u32, u32]> }
      >;
      /** Oracle was removed from the whitelist. */
      RemovedFromWhitelist: AugmentedEvent<
        ApiType,
        [source: U8aFixed, assets: ITuple<[u32, u32]>],
        { source: U8aFixed; assets: ITuple<[u32, u32]> }
      >;
    ...
    evmAccounts: {
      /** Binding was created. */
      Bound: AugmentedEvent<
        ApiType,
        [account: AccountId32, address: H160],
        { account: AccountId32; address: H160 }
      >;
      /** Deployer was added. */
    ...
    identity: {
      ...
      >;
      /**
       * A dangling username (as in, a username corresponding to an account that
       * has removed its identity) has been removed.
       */
    ...
    omnipool: {
      ...
      ProtocolLiquidityRemoved: AugmentedEvent<
        ApiType,
        [
          who: AccountId32,
          assetId: u32,
      ...
      TokenRemoved: AugmentedEvent<
        ApiType,
        [assetId: u32, amount: u128, hubWithdrawn: u128],
        { assetId: u32; amount: u128; hubWithdrawn: u128 }
      >;
    ...
    referrals: {
      ...
      AssetRewardsUpdated: AugmentedEvent<
        ApiType,
        [
          assetId: u32,
    ...
    stableswap: {
      ...
      AmplificationChanging: AugmentedEvent<
        ApiType,
        [
          poolId: u32,
      ...
      >;
      /**
       * Buy trade executed. Trade fee paid in asset entering the pool (already
       * included in amount_in).
       */
      BuyExecuted: AugmentedEvent<
        ApiType,
        [
      ...
      FeeUpdated: AugmentedEvent<
        ApiType,
        [poolId: u32, fee: Permill],
        { poolId: u32; fee: Permill }
      >;
      ...
      PoolCreated: AugmentedEvent<
        ApiType,
        [poolId: u32, assets: Vec<u32>, amplification: u16, fee: Permill],
        { poolId: u32; assets: Vec<u32>; amplification: u16; fee: Permill }
      >;
      /**
       * Sell trade executed. Trade fee paid in asset leaving the pool (already
       * subtracted from amount_out).
       */
      SellExecuted: AugmentedEvent<
        ApiType,
        [
      ...
      TradableStateUpdated: AugmentedEvent<
        ApiType,
        [poolId: u32, assetId: u32, state: PalletStableswapTradability],
        { poolId: u32; assetId: u32; state: PalletStableswapTradability }
      >;
      /** Generic event */
      [key: string]: AugmentedEvent<ApiType>;
    ...
    staking: {
      ...
      AccumulatedRpsUpdated: AugmentedEvent<
        ApiType,
        [accumulatedRps: u128, totalStake: u128],
        { accumulatedRps: u128; totalStake: u128 }
      >;
      /** New staking position was created and NFT was minted. */
      PositionCreated: AugmentedEvent<
        ApiType,
        [who: AccountId32, positionId: u128, stake: u128],
        { who: AccountId32; positionId: u128; stake: u128 }
      >;
      /** Rewards were claimed. */
      ...
      StakingInitialized: AugmentedEvent<
        ApiType,
      ...
      Unstaked: AugmentedEvent<
        ApiType,
        [who: AccountId32, positionId: u128, unlockedStake: u128],
        { who: AccountId32; positionId: u128; unlockedStake: u128 }
      >;
      /** Generic event */
      [key: string]: AugmentedEvent<ApiType>;
    ...
    stateTrieMigration: {
      ...
      >;
      /**
       * Given number of `(top, child)` keys were migrated respectively, with
       * the given `compute`.
       */
    ...
    treasury: {
      ...
      >;
      /**
       * A spend was processed and removed from the storage. It might have been
       * successfully paid or it may have expired.
       */

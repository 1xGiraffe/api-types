...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    readonly id: HydradxRuntimeRuntimeHoldReason;
    ...
    broadcast: {
       ...
       **/
      executionContext: AugmentedQuery<ApiType, () => Observable<Vec<PalletBroadcastExecutionType>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    circuitBreaker: {
      ...
      assetLockdownState: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletCircuitBreakerLockdownStatus>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    dca: {
       ...
       **/
      scheduleExecutionBlock: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u32>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    dynamicFees: {
       ...
       **/
      assetFeeConfiguration: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletDynamicFeesAssetFeeConfig>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    evmAccounts: {
       ...
       **/
      approvedContract: AugmentedQuery<ApiType, (arg: H160 | string | Uint8Array) => Observable<Option<Null>>, [H160]> & QueryableStorageEntry<ApiType, [H160]>;
      /**
    ...
    liquidation: {
       ...
       **/
      borrowingContract: AugmentedQuery<ApiType, () => Observable<H160>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    parameters: {
      isTestnet: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    staking: {
       ...
       **/
      votes: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<PalletStakingVoting>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * List of processed vote. Used to determine if the vote should be locked in case of voting not in favor.
       **/
      votesRewarded: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletStakingVote>>, [AccountId32, u32]> & QueryableStorageEntry<ApiType, [AccountId32, u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;

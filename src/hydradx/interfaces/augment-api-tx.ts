...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    circuitBreaker: {
       ...
       **/
      forceLiftLockdown: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      /**
       ...
       **/
      lockdownAsset: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array, until: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32]>;
      /**
       ...
       **/
      releaseDeposit: AugmentedSubmittable<(who: AccountId32 | string | Uint8Array, assetId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, u32]>;
      /**
    ...
    dca: {
       ...
       * 
       **/
      unlockReserves: AugmentedSubmittable<(who: AccountId32 | string | Uint8Array, assetId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    dispatcher: {
       ...
       **/
      dispatchWithExtraGas: AugmentedSubmittable<(call: Call | IMethod | string | Uint8Array, extraGas: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Call, u64]>;
      /**
    ...
    dynamicFees: {
       ...
       **/
      removeAssetFee: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      /**
       ...
       **/
      setAssetFee: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array, config: PalletDynamicFeesAssetFeeConfig | { Fixed: any } | { Dynamic: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, PalletDynamicFeesAssetFeeConfig]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    hsm: {
       ...
       **/
      addCollateralAsset: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array, poolId: u32 | AnyNumber | Uint8Array, purchaseFee: Permill | AnyNumber | Uint8Array, maxBuyPriceCoefficient: u128 | AnyNumber | Uint8Array, buyBackFee: Permill | AnyNumber | Uint8Array, buybackRate: Perbill | AnyNumber | Uint8Array, maxInHolding: Option<u128> | null | Uint8Array | u128 | AnyNumber) => SubmittableExtrinsic<ApiType>, [u32, u32, Permill, u128, Permill, Perbill, Option<u128>]>;
      /**
       * Buy asset from HSM
       * 
       ...
       * - Other errors from underlying calls
       **/
      buy: AugmentedSubmittable<(assetIn: u32 | AnyNumber | Uint8Array, assetOut: u32 | AnyNumber | Uint8Array, amountOut: u128 | AnyNumber | Uint8Array, slippageLimit: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, u128, u128]>;
      /**
       ...
       * - Other errors from underlying calls
       **/
      executeArbitrage: AugmentedSubmittable<(collateralAssetId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      /**
       ...
       **/
      removeCollateralAsset: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      /**
       * Sell asset to HSM
       * 
       * This function allows users to:
       ...
       * - Other errors from underlying calls
       **/
      sell: AugmentedSubmittable<(assetIn: u32 | AnyNumber | Uint8Array, assetOut: u32 | AnyNumber | Uint8Array, amountIn: u128 | AnyNumber | Uint8Array, slippageLimit: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, u128, u128]>;
      setFlashMinter: AugmentedSubmittable<(flashMinterAddr: H160 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H160]>;
      /**
       ...
       * - `AssetNotApproved` if the asset is not a registered collateral
       **/
      updateCollateralAsset: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array, purchaseFee: Option<Permill> | null | Uint8Array | Permill | AnyNumber, maxBuyPriceCoefficient: Option<u128> | null | Uint8Array | u128 | AnyNumber, buyBackFee: Option<Permill> | null | Uint8Array | Permill | AnyNumber, buybackRate: Option<Perbill> | null | Uint8Array | Perbill | AnyNumber, maxInHolding: Option<Option<u128>> | null | Uint8Array | Option<u128> | u128 | AnyNumber) => SubmittableExtrinsic<ApiType>, [u32, Option<Permill>, Option<u128>, Option<Permill>, Option<Perbill>, Option<Option<u128>>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    referenda: {
       ...
       * Emits `Submitted`.
       **/
      submit: AugmentedSubmittable<(proposalOrigin: HydradxRuntimeOriginCaller | { system: any } | { Void: any } | { TechnicalCommittee: any } | { Origins: any } | { Ethereum: any } | { PolkadotXcm: any } | { CumulusXcm: any } | string | Uint8Array, proposal: FrameSupportPreimagesBounded | { Legacy: any } | { Inline: any } | { Lookup: any } | string | Uint8Array, enactmentMoment: FrameSupportScheduleDispatchTime | { At: any } | { After: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [HydradxRuntimeOriginCaller, FrameSupportPreimagesBounded, FrameSupportScheduleDispatchTime]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    stableswap: {
       ...
       * 
       **/
      updateAssetPegSource: AugmentedSubmittable<(poolId: u32 | AnyNumber | Uint8Array, assetId: u32 | AnyNumber | Uint8Array, pegSource: PalletStableswapPegSource | { Value: any } | { Oracle: any } | { MMOracle: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, PalletStableswapPegSource]>;
      /**
       * Update pool's fee.
       * 
       ...
       * 
       **/
      updatePoolMaxPegUpdate: AugmentedSubmittable<(poolId: u32 | AnyNumber | Uint8Array, maxPegUpdate: Permill | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, Permill]>;
      /**
    ...
    utility: {
       ...
       * - O(1).
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: HydradxRuntimeOriginCaller | { system: any } | { Void: any } | { TechnicalCommittee: any } | { Origins: any } | { Ethereum: any } | { PolkadotXcm: any } | { CumulusXcm: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [HydradxRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
    ...
    xyk: {
      ...
      addLiquidityWithLimits: AugmentedSubmittable<(assetA: u32 | AnyNumber | Uint8Array, assetB: u32 | AnyNumber | Uint8Array, amountA: u128 | AnyNumber | Uint8Array, amountBMaxLimit: u128 | AnyNumber | Uint8Array, minShares: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, u128, u128, u128]>;
      /**
       ...
       **/
      removeLiquidity: AugmentedSubmittable<(assetA: u32 | AnyNumber | Uint8Array, assetB: u32 | AnyNumber | Uint8Array, shareAmount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, u128]>;
      removeLiquidityWithLimits: AugmentedSubmittable<(assetA: u32 | AnyNumber | Uint8Array, assetB: u32 | AnyNumber | Uint8Array, shareAmount: u128 | AnyNumber | Uint8Array, minAmountA: u128 | AnyNumber | Uint8Array, minAmountB: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, u128, u128, u128]>;
      /**
       * Trade asset in for asset out.
       * 
       * Executes a swap of `asset_in` for `asset_out`. Price is determined by the liquidity pool.
